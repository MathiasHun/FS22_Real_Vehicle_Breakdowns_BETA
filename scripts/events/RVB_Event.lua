...
function RVB_Event.new(vehicle, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10 )
	local elements = { b1, b2, b3, b4, b5, b6, b7, b8, b9, b10 }
...
function RVB_Event:readStream(streamId, connection)
	...
	self.vehicle.spec_faultData.faultStorage[9] = streamReadFloat32(streamId)
	self.vehicle.spec_faultData.faultStorage[10] = streamReadFloat32(streamId)
...
function RVB_Event:writeStream(streamId, connection)
	...
	streamWriteFloat32(streamId, self.vehicle.spec_faultData.faultStorage[9])
	streamWriteFloat32(streamId, self.vehicle.spec_faultData.faultStorage[10])
...
function RVB_Event.sendEvent( vehicle, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10 )
	local elements = { b1, b2, b3, b4, b5, b6, b7, b8, b9, b10 }
	if g_server ~= nil then
